...
class GraphContainer : View {
    ...
    private val graphRect: RectF get() = RectF(0f, headerHeight, canvasWidth, canvasHeight - footerHeight)
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        for (i in graphViews.indices) {
            ...
            val graphBitmap =
                createBitmap(graphRect.width().toInt(), graphRect.height().toInt(), Bitmap.Config.ARGB_8888)
